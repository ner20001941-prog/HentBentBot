...
async def send_channel_link(update: Update, context: ContextTypes.DEFAULT_TYPE):
...
async def test_link_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
...
async def full_test(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """Полная проверка"""
    user_id = update.effective_user.id
...
async def remove_user_from_channel(user_id: int, context: ContextTypes.DEFAULT_TYPE):
...
async def view_expired(update: Update, context: ContextTypes.DEFAULT_TYPE):
